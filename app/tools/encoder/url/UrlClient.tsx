...
function decodeUrl(text: string): { result: string; error: string | null } {
  try {
    return {
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              className={`h-48 p-3 text-sm bg-gray-800 border rounded-lg text-white placeholder-gray-500 resize-none focus:outline-none font-mono ${
